package com.example.mmrag.config;
...
public class AiConfig {
	 ...
	 ApplicationRunner loadDocumentToVectorStore(
	            ...
	            Tokenizer tokenizer,
	            @Value("classpath:/docs/AKS.pdf") Resource pdfResource){
	        return args -> {
	 ...
	 public void loadDataIntoVectorStore(Resource pdfResource,Tokenizer tokenizer,
             ChatLanguageModel chatLanguageModel,EmbeddingStoreIngestor embeddingStoreIngestor
		 ...
		 for (PDPage pdPage : pdPages) {
			 ...
			 for (var c : resources.getXObjectNames()) {
				 ...
				 if (pdxObject instanceof PDImageXObject image) {
					 ...
					 String imagePath = "/Users/sourav/Documents/Development/AI/mmrag/images/page_" + page + "_im_" + index + ".jpg";
					 FileOutputStream fileOutputStream = new FileOutputStream(imagePath);
					 ImageIO.write(imageImage, "jpg", fileOutputStream);
					 ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
					 ImageIO.write(imageImage, "jpg", byteArrayOutputStream);
					// ImageIO.write(imageImage, "jpg", new File(imagePath));
					 byte[] data = byteArrayOutputStream.toByteArray();
					 
					 String imageBase64 = Base64.getEncoder().encodeToString(data);
					 String dataUrl = "data:image/jpg;base64,"+imageBase64;
					 
					 //Image img = Image.builder()
						//	 .base64Data(imageBase64)
						//	 .mimeType("image/JPEG")
						//	 .build();
					 //ImageContent imageContent1 = ImageContent.from(imageBase64,"image/jpg");
					 //Media media1 = new Media(MimeTypeUtils.IMAGE_PNG, new ByteArrayResource(data));
					 media.add(imagePath);

					 System.out.println("dataUrl ::"+ dataUrl);
					 
					 UserMessage userMessage = UserMessage.from(TextContent.from("Give me a description of  the provided image"),
